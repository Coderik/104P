...
void GaussianKernel::build_kernel()
{
	...
	float sigma_x = (float)_size_x / 6;
	float sigma_y = (float)_size_y / 6;
	float sigma_z = (float)_size_z / 6;

	float x_a = - (float)_size_x / 2;
	float x_b = (float)_size_x / 2;
	float y_a = - (float)_size_y / 2;
	float y_b = (float)_size_y / 2;
	float z_a = - (float)_size_z / 2;
	float z_b = (float)_size_z / 2;
